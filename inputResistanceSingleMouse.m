...
folder = 'KF_210628_analyzed'; % Naming conventions
run = '21628008 - Copy - analyzed - all traces'; % Clampex ABF naming conventions, refer to "E-I Ratio Stats ASTN2" Excel sheet for proper name
